 ...
 * @LastEditTime: 2021-12-03 15:57:13
 * @Description: json schema编辑器
 * @FilePath: \vue3-json-schema\examples\components\json-schema\JsonSchemaEditor.vue
-->
<template>
...
import SchemaJson from "./schema/SchemaJson.vue";
import BasicDialog from "./dialog/BasicDialog.vue";
import Json2SchemaDialog from "./dialog/Json2SchemaDialog.vue";
import StringDialog from "./dialog/StringDialog.vue";
import NumberDialog from "./dialog/NumberDialog.vue";
import ArrayDialog from "./dialog/ArrayDialog.vue";

import {
  DEFAULT_SCHEMA,
  SCHEMA_TYPE,
  JSON_PATH_JOIN_CHAR,
} from "./js/schema-constant";
import { uuid } from "./js/json-schema";
